...
import { Row, Col, Select, Form, Icon, Input, Button, Radio } from 'antd';
              ...
              {info.map((form,index)=>{
                  ...
                  return (
                    ...
                    > 
                      ...
                      {/* <Input placeholder={'请输入'+form.title}/> */}
                    </FormItem>
                  )
              })}
            </Form>
            <div className={styles.btn}><Button type="primary">下一步</Button><Button onClick={this.handleClick}>返回</Button></div>
          </Col>
